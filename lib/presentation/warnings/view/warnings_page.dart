...
class _WarningsPageState extends State<WarningsPage> {
  ...
  void _showWarningDetails(BuildContext context, Map<String, dynamic> warning) {
    // Try to get warning_id from the warning object
    final warningId = warning['warning_id']?.toString() ?? '';
    
    if (warningId.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Warning ID not available'),
    ...
    // Navigate to warning details page
    Navigator.pushNamed(
      context,
      AppConstants.routeWarningDetails,
      arguments: {
